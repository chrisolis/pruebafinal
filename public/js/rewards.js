jQuery(document).ready(function() {
	jQuery('.donut_singleContainer').each(function(idx) {
		...
		if(con > 0) {
			...
			cont1 = '<div class="progressTracker"><div class="container-login100-form-btn"><div class="wrap-login100-form-btn"><div class="login100-form-bgbtn"></div><a href="'  + '" class="login100-form-btn">FELICIDADES LO LOGRASTE</a></div></div></div>'
		} else {
			cont = prog + '%';
		}
